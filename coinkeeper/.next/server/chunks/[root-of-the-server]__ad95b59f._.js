...
async function GET(request) {
    try {
        ...
        const startDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$subDays$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["subDays"])(endDate, timeRange);
        ...
        const dailySummary = transactions.reduce((acc, transaction)=>{
            const date = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(transaction.date, 'yyyy-MM-dd');
        ...
        const categorySummary = Object.entries(categoryTotals).map(([name, amount])=>({
                name,
                amount,
        ...
        let currentDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$startOfMonth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["startOfMonth"])(startDate);
        const endOfPeriod = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$endOfMonth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["endOfMonth"])(endDate);
        while(currentDate <= endOfPeriod){
            const monthEnd = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$endOfMonth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["endOfMonth"])(currentDate);
            const monthTransactions = transactions.filter((t)=>t.date >= currentDate && t.date <= monthEnd);
            const monthIncome = monthTransactions.filter((t)=>t.type === 'income').reduce((sum, t)=>sum + t.amount, 0);
            const monthExpense = monthTransactions.filter((t)=>t.type === 'expense').reduce((sum, t)=>sum + t.amount, 0);
            const savings = monthIncome - monthExpense;
            const savingsRate = monthIncome > 0 ? savings / monthIncome * 100 : 0;
            monthlyComparison.push({
                month: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(currentDate, 'MMM yyyy'),
                income: monthIncome,
                expense: monthExpense,
                savings,
                savingsRate
            });
            currentDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$addDays$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["addDays"])(monthEnd, 1);
        }
        // Fetch goals
        const goals = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].goal.findMany({
            where: {
                userId
            },
            select: {
        ...
        const goalsWithProgress = goals.map((goal)=>{
            ...
            const daysLeft = goal.deadline ? Math.ceil(((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parseISO$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseISO"])(goal.deadline.toString()).getTime() - new Date().getTime()) / (1000 * 60 * 60 * 24)) : null;
            return {
                ...goal,
                progress,
                daysLeft
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ad95b59f._.js.map